...
<body>
    ...
    <h2>Students List</h2> <?php
    if (isset($_GET['error']) && $_GET['error'] === 'DuplicateRegistrationNumber') {
       echo '<div class="error">Error: Duplicate Registration Number Is Not Allowed</div>';
    }
    ?>
    <ul>
